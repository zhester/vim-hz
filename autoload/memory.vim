...
let s:memory = [
\   'ag.vim, search project for current word: ' . s:leader . 'a',
\   'vim-gitgutter, toggle gutter: ' . s:leader . 'g',
...
\   'Vim*, copy to clipboard: gy',
\   'Vim*, paste from clipboard: gp',
...
\   'Plug, install and/or update plugins: ' . s:leader . 'U',
...
"\   'Vim*, display syntax names: ' . s:leader . 'z',
